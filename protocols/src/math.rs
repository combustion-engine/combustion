...
impl<'a> protocol::matrix4::Builder<'a> {
...
impl<'a> protocol::vector3::Builder<'a> {
...
impl<'a> protocol::vector3::Reader<'a> {
    #[inline]
...
impl<'a> protocol::point3::Builder<'a> {
...
impl<'a> protocol::point3::Reader<'a> {
    #[inline]
